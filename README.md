...
# typescript-angularjs client for Apple Wallet and Google Wallet API

Demo API client (typescript-angularjs) for [passmeister.com](https://www.passmeister.com), the easiest developer API to create the most beautiful iOS and Android Wallet passes.
